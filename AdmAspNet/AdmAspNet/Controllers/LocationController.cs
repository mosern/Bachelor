...
namespace AdmAspNet.Controllers
{
    public class LocationController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include ="Type",Exclude ="Type.Name")]LocationViewModel input)
        {
            List<Models.DataContracts.Type> list = api.GetAllTypes();
            var mapper = mapConfig.CreateMapper();
            List<TypeViewModel> listViewModel = mapper.Map<List<TypeViewModel>>(list);
            ...
            coordinate.Id = 1;
            locationObject.Coordinate = coordinate; 
            //api.PostLocation(locationObject); 
            return View(input); 
        }
